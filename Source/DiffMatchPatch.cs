...
namespace DiffMatchPatch {
  ...
  public List<Diff> diff_lineWordDiff(string text1, string text2, string delim) {
      Object[] a = diff_linesToChars(text1, text2, delim);
      text1 = (string)a[0];
      text2 = (string)a[1];
     ...
     */
    protected Object[] diff_linesToChars(string text1, string text2,string delim) {
      ...
      string chars1 = diff_linesToCharsMunge(delim, text1, lineArray, lineHash, 40000);
      string chars2 = diff_linesToCharsMunge(delim, text2, lineArray, lineHash, 65535);
     ...
     */
    private string diff_linesToCharsMunge(string delim,string text, List<string> lineArray,
      ...
      while (lineEnd < text.Length - 1) {
        lineEnd = text.IndexOf(delim, lineStart);
        if (lineEnd == -1) {
